...
public class FirstTimeLoginPage extends JFrame implements ActionListener {
	...
	final static Logger logger = Logger.getLogger(FirstTimeLoginPage.class);
	...
	FirstTimeLoginPage(boolean isDashboard) {
	...
	public void setLocationAndSize() {
		...
		logOutLabel.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				((FirstTimeLoginPage) e.getComponent().getParent().getParent().getParent().getParent()).dispose();
			}
		});
