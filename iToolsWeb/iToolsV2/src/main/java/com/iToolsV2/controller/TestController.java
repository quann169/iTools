...
public class TestController {
    ...
    @RequestMapping(value = { "/test/accountInfo" }, method = RequestMethod.GET)
    ...
    @RequestMapping(value = { "/test/orderList" }, method = RequestMethod.GET)
    ...
    @RequestMapping(value = { "/test/product" }, method = RequestMethod.POST)
