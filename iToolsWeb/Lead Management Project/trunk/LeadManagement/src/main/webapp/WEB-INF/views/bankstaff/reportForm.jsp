...
<section style="background-color: #f1f1f1;">
	<form:form action="${pageContext.request.contextPath}/public/register" modelAttribute="reportForm" class="form-horizontal ">
		<fieldset>
	...
	<div class="margin-top-l"></div>
	 <section>
		<div class="col col-sm-12">			
			Tổng cộng <b>5</b> kết quả theo điều kiện tìm kiếm			
		</div>
		<table class="result margin-bottom-l">
			<tr class="header">				
				<td>Mã số NVNH</td>
				<td>Họ tên NVNH</td>
				<td>Ngày giới thiệu</td>
				<td>Chi nhánh giới thiệu</td>
				<td>Phòng giao dịch giới thiệu</td>
			...
			<tr class="detail">				
				...
				<td>Trần Văn A</td>
				<td>01/12/2017</td>
				<td>CN Ba Ria Vung Tau</td>
				<td>PGD Ba Muoi Thang Tu</td>
				<td>Nguyen Van A</td>
				<td>01/01/1992</td>
				<td>Đã kết hôn</td>
				<td>0911234566</td>
