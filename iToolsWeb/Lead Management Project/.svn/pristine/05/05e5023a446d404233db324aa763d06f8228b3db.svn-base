			...
			<fieldset>
				...
				<div class="col col-sm-12">
					<div class="col col-sm-6">
						<div class="form-group">
							<form:label path="fullName" class="col col-sm-12 control-label text-left">
								Mã Tư vấn tài chính (FSC)<span class="manda">*</span>
							</form:label>
							<div class="col col-sm-12">
					...
					<div class="col col-sm-6">
						<div class="form-group">
							<form:label path="fullName" class="col col-sm-12 control-label text-left">
								Tên Tư vấn tài chính (FSC)<span class="manda">*</span>
							</form:label>
							<div class="col col-sm-12">
								<form:input path="fullName" class="form-control" />
								<form:errors path="fullName" cssClass="text-danger" />
				...
				<div class="col col-sm-12">
					<div class="col col-sm-6">
						<div class="form-group">
							<form:label path="fullName"
								...
								Chi nhánh giới thiệu<span class="manda">*</span>
							</form:label>
							<div class="col col-sm-12">
								<select class="form-control fancy-select-box">
		                           <option value='VN0010002'>CN An Giang</option>
									<option value='VN0010032'>CN Ba Ria Vung Tau</option>
									<option value='VN0010069'>CN Bac Lieu</option>
									<option value='VN0010035'>CN Bac Ninh</option>
									<option value='VN0010106'>CN Ben Thanh</option>
									<option value='VN0010003'>CN Binh Duong</option>
									<option value='VN0010041'>CN Binh Phuoc</option>
									<option value='VN0010046'>CN Binh Thuan</option>
									<option value='VN0010005'>CN Can Tho</option>
									<option value='VN0010081'>CN Chanh Hung</option>
									<option value='VN0010006'>CN Da Nang</option>
									<option value='VN0010158'>CN Dien Bien</option>
									<option value='VN0010079'>CN Dinh Tien Hoang</option>
									<option value='VN0010013'>CN Dong Da</option>
									<option value='VN0010105'>CN Dong Ha Noi</option>
									<option value='VN0010008'>CN Dong Nai</option>
									<option value='VN0010009'>CN Dong Thap</option>
									<option value='VN0010074'>CN Gia Lai</option>
									<option value='VN0010011'>CN Ha Noi</option>
									<option value='VN0010075'>CN Hai Phong</option>
									<option value='VN0010052'>CN Ho Chi Minh</option>
									<option value='VN0010122'>CN Hoang Cau</option>
									<option value='VN0010116'>CN Hoang Quoc Viet</option>
									<option value='VN0010048'>CN Hung Yen</option>
									<option value='VN0010073'>CN Khanh Hoa</option>
									<option value='VN0010053'>CN Kien Giang</option>
									<option value='VN0010155'>CN Lang Son</option>
									<option value='VN0010028'>CN Long An</option>
									<option value='VN0010154'>CN Nghe An</option>
									<option value='VN0010036'>CN Quang Nam</option>
									<option value='VN0010072'>CN Quang Ninh</option>
									<option value='VN0010027'>CN Quang Trung</option>
									<option value='VN0010029'>CN Sai Gon</option>
									<option value='VN0010111'>CN Soc Trang</option>
									<option value='VN0010068'>CN Son La</option>
									<option value='VN0010047'>CN Tay Ninh</option>
									<option value='VN0010157'>CN Thai Binh</option>
									<option value='VN0010051'>CN Thai Nguyen</option>
									<option value='VN0010156'>CN Thanh Hoa</option>
									<option value='VN0010037'>CN Thua Thien Hue</option>
									<option value='VN0010058'>CN Tien Giang</option>
									<option value='VN0010031'>CN Vinh Long</option>
									<option value='VN0010059'>CN Vinh Phuc</option>
	                        	</select>
								<form:errors path="fullName" cssClass="text-danger" />
							</div>
						</div>
					...
					<div class="col col-sm-6">
						<div class="form-group">
							<form:label path="fullName"
								class="col col-sm-12 control-label text-left">
								Phòng giao dịch giới thiệu<span class="manda">*</span>
							</form:label>
							<div class="col col-sm-12">							
								<select class="form-control fancy-select-box">
		                            <option value='VN0010002'>CN An Giang</option>
									<option value='VN0010002'>Phong ke toan</option>
									<option value='VN0010002_1'>Phong KHCN</option>		                            
	                        	</select>
								<form:errors path="fullName" cssClass="text-danger" />							
							</div>
						</div>
				...
				<div class="col col-sm-12">
					<div class="col col-sm-6">
						<div class="form-group">
							<form:label path="fullName"
								class="col col-sm-12 control-label text-left">
								Danh xưng<span class="manda">*</span>
							</form:label>
							<div class="col col-sm-12">
								<select class="form-control fancy-select-box">
		                            <option value='VN0010002'>Anh</option>
									<option value='VN0010002'>Chị</option>											                            
	                        	</select>
							</div>
						</div>
					</div>
					<div class="col col-sm-6">
						<div class="form-group">
							<form:label path="fullName"
								class="col col-sm-12 control-label text-left">
								Họ và tên<span class="manda">*</span>
							</form:label>
							<div class="col col-sm-12">
								<form:input path="fullName" class="form-control" />
								<form:errors path="fullName" cssClass="text-danger" />
				...
				<div class="col col-sm-12">
					<div class="col col-sm-6">
						<div class="form-group">
							<form:label path="fullName"
								class="col col-sm-12 control-label text-left">
								Ngày tháng năm sinh<span class="manda">*</span>
							</form:label>
							<div class="col col-sm-12">
								<form:input path="fullName" class="form-control" />
								<form:errors path="fullName" cssClass="text-danger" />
					...
					<div class="col col-sm-6">
						<div class="form-group">
							<form:label path="fullName"
								class="col col-sm-12 control-label text-left">
								Tình trạng hôn nhân<span class="manda">*</span>
							</form:label>
							<div class="col col-sm-12">
								<select class="form-control fancy-select-box">
		                            <option value='VN0010002'>Độc Thân</option>
									<option value='VN0010002'>Kết Hôn</option>											                            
									<option value='VN0010002'>Kết Khác</option>
	                        	</select>
								<form:errors path="fullName" cssClass="text-danger" />
							</div>
						</div>
				...
				<div class="col col-sm-12">
					<div class="col col-sm-6">
						<div class="form-group">
							<form:label path="fullName"
								class="col col-sm-12 control-label text-left">
								Số điện thoại liên lạc<span class="manda">*</span>
							</form:label>
							<div class="col col-sm-12">
								<form:input path="fullName" class="form-control" />
								<form:errors path="fullName" cssClass="text-danger" />
					...
					<div class="col col-sm-6">
						<div class="form-group">
							<form:label path="fullName"
								class="col col-sm-12 control-label text-left">
								Địa chỉ email<span class="manda">*</span>
							</form:label>
							<div class="col col-sm-12">
								<form:input path="fullName" class="form-control" />
								<form:errors path="fullName" cssClass="text-danger" />
				...
				<div class="col col-sm-12">
					<label class="checkbox">
						...
						<span class="p3">						
								Mong muốn giải pháp đảm bảo Tương lai học vấn đầy đủ cho con					
						</span>					
					</label>
				</div>
				<div class="col col-sm-12">
					<label class="checkbox">
						...
						<span class="indicator"><span class="tick"></span></span>					
						<span class="p3">						
							Mong muốn giải pháp bảo vệ cho bản thân trước những rủi ro cuộc sống						
						</span>					
					</label>
				</div>
							<div class="col col-sm-12">
					<label class="checkbox">
						...
						<span class="indicator"><span class="tick"></span></span>					
						<span class="p3">						
							Mong muốn một khoản tích lũy an toàn khi về hưu và tận hưởng cuộc sống					
						</span>					
					</label>
				</div>
				<div class="col col-sm-12">
