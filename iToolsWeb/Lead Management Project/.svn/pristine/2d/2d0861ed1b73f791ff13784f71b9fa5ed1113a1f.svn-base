...
<div class="join-us">
	...
	<section style="background-color: #f1f1f1;" class="">
		...
		<form:form id="payment_confirmation" modelAttribute="paymentForm" 
			action="https://testsecureacceptance.cybersource.com/embedded/pay"
			method="post" target="output_frame" >
		...
		<div class="iframe-wrapper">
			<iframe name="output_frame" src="" id="output_frame" width="760" height="1800" frameborder="0"	marginheight="0" marginwidth="0"></iframe>
		</div>
